...
async function transliterateToAmharic(description) {
        ...
        const response = await axios.post(OPENAI_API_ENDPOINT,
         {
            ...
            analyse the two teams name from the description,  return the transliteration of the analysed team name for "Amharic (Geez Script) and dont for get to include there result between them 
            don't add any explanations! don't say club.EnglishName! just return the translation! don't add \ n too!!!
            example: "Stalemate with the Seagulls | Brighton 0-0 Wolves | Highlights", return "ብራይተን 0-0 ዎልቭስ"
