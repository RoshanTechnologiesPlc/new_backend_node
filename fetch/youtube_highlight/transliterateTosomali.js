        ...
        const response = await axios.post(OPENAI_API_ENDPOINT,
         {
            ...
            analyse the two teams name from the description,  return the transliteration of the analysed team name for "oromigna and dont for get to  include there  result between them 
